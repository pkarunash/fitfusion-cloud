...
('Creatine Monohydrate 250g','creatine-monohydrate-250g','protein','IronForge','Micronised creatine for strength and power output. 5g unflavoured dose.',899,1399,120,4.7,980,'{}','[{"label":"Weight","value":"250 g (50 servings)"},{"label":"Dose","value":"5 g"},{"label":"Type","value":"Micronised Monohydrate"}]'),
...
('Lifting Belt 4-inch Leather','lifting-belt-leather','accessory','IronForge','Double-prong 4 inch leather belt for heavy squats and deadlifts.',2499,3499,45,4.7,231,'{}','[{"label":"Width","value":"4 inch"},{"label":"Thickness","value":"10 mm"},{"label":"Material","value":"Full grain leather"}]'),
...
('Monthly Starter',1,1499,1999,'Full gym floor access, perfect to try us out.','{"Gym floor + cardio zone","Locker access","1 free body composition scan"}',false,1),
('Quarterly Shred',3,3799,5997,'Best value with group classes and a coach check-in.','{"Everything in Starter","Unlimited group classes","Monthly coach check-in","10% off store orders"}',true,2),
('Annual Beast',12,11999,17988,'Full-year transformation package with personal training.','{"Everything in Quarterly","12 personal training sessions","Custom diet plan","Free shaker + gym tee","20% off store orders"}',false,3),
('Personal Training Add-on',1,4999,6999,'8 one-on-one sessions with a certified strength coach.','{"8 PT sessions","Form video analysis","Weekly progress tracking"}',false,4);